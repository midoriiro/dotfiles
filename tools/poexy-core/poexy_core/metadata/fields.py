    ...
    def format_value(self, value: str) -> str:
        if self.multiline:
            ...
            value = textwrap.indent(
                value, " " * len(field_key), lambda _: True
            )
            value = value.strip()
        return value
...
class MetadataField(Enum):
    # Version 1.0
    MetadataVersion = _MetadataField("Metadata-Version", MetadataVersions.V1_0, required=True)
    ...
    License = _MetadataField("License", MetadataVersions.V1_0, multiline=True, deprecated_since=MetadataVersions.V2_4)
    HomePage = _MetadataField("Home-Page", MetadataVersions.V1_0, deprecated_since=MetadataVersions.V1_2)

    # Version 1.1
    SupportedPlatforms = _MetadataField("Supported-Platforms", MetadataVersions.V1_1, multiuse=True)
    Classifier = _MetadataField("Classifier", MetadataVersions.V1_1, multiuse=True)
    DownloadURL = _MetadataField("Download-URL", MetadataVersions.V1_1, deprecated_since=MetadataVersions.V1_2)
    Requires = _MetadataField("Requires", MetadataVersions.V1_1, deprecated_since=MetadataVersions.V1_2)
    Provides = _MetadataField("Provides", MetadataVersions.V1_1, deprecated_since=MetadataVersions.V1_2)
    Obsoletes = _MetadataField("Obsoletes", MetadataVersions.V1_1, deprecated_since=MetadataVersions.V1_2)
    ...
    RequiresExternal = _MetadataField("Requires-External", MetadataVersions.V1_2, multiuse=True)
    ProjectURL = _MetadataField("Project-URL", MetadataVersions.V1_2, multiuse=True)
    ObsoletesDist = _MetadataField("Obsoletes-Dist", MetadataVersions.V1_2, multiuse=True)

    # Version 2.1
    DescriptionContentType = _MetadataField("Description-Content-Type", MetadataVersions.V2_1)
    ProvidesExtra = _MetadataField("Provides-Extra", MetadataVersions.V2_1, multiuse=True)
    ...
    # Version 2.4
    LicenseExpression = _MetadataField("License-Expression", MetadataVersions.V2_4, multiuse=True)
