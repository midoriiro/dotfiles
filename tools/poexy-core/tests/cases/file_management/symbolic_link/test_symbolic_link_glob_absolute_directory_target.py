"""
Test case: Glob absolute symlink resolution (directory target)

This test verifies that poexy-core correctly rejects absolute symbolic links
during glob pattern matching, even when the target is a directory within
...
def project_path(sample_project):
    return sample_project(
        ...
        / "symbolic_link_glob_absolute_directory_target"
    )
