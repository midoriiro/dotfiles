...
from ignite.models.container import Container, Image, Workspace as ContainerWorkspace
...
@pytest.fixture
def minimal_configuration(minimal_container_configuration, minimal_workspace_configuration):
