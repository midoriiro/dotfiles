...
from ignite.models.fs import Folder, File, ResolvedFolder
...
class TestVSCodeFolderCreation:
    ...
    def test_create_vscode_folder_with_mixed_content(self):
        ...
        vscode_folder = VSCodeFolder(
            settings=[settings_folder, settings_file],
            tasks=[tasks_folder, tasks_file]
        )
    ...
    def test_resolve_vscode_folder_with_nested_folders(self):
        ...
        settings_folder = Folder({
            "python": [
                File("base"),
                Folder({
                    "linting": [File("black"), File("flake8")]
                })
            ]
        })
        tasks_folder = Folder({
            "poetry": [
                File("build"),
                Folder({
                    "testing": [File("test"), File("coverage")]
                })
            ]
        })
            ...
            "python": [
                ...
                Folder({
                    "linting": [
                        File("black"),
                        Folder({
                            "config": [File("black"), File("pyproject")]
                        })
                    ],
...
class TestVSCodeFolderModelBehavior:
    ...
    def test_vscode_folder_with_multiple_settings_sources(self):
        ...
        settings_folder1 = Folder({
            "python": [File("base")]
        })
        settings_folder2 = Folder({
            "typescript": [File("base")]
        })
    ...
    def test_vscode_folder_with_multiple_tasks_sources(self):
        ...
        tasks_folder1 = Folder({
            "poetry": [File("build")]
        })
        tasks_folder2 = Folder({
            "npm": [File("build")]
        })
        tasks_file = File("global")
        
        vscode_folder = VSCodeFolder(
            tasks=[tasks_folder1, tasks_folder2, tasks_file]
        )
        resolved = vscode_folder.resolve()
